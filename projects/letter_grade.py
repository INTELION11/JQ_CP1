...
while True:
    ...
    if grade >= 92:
        print(f"your {grade}% is equal to an A, could have done better")
    elif  grade >= 90 and grade <= 91:
        print(f"your {grade}% is equal to an -A, not an A+? you dont deserve anything")
    elif  grade >= 87 and grade <= 89:
        print(f"your {grade}% is equal to an B+, i see, you lazy good for nothing")
    elif  grade >= 82 and grade <= 86:
        print(f"your {grade}% is equal to an B, Below avarage, as expected but im stil disapointed")
    elif  grade >= 80 and grade <= 81:
        print(f"your {grade}% is equal to an B-, bother is on the verge of failing")
